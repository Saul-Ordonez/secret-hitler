import { Game, Players } from './../src/backend.js'
...
describe ('Game', () => {
  ...
  test('should assign two players a fascist and one of them as hitler', () => {
    ...
    let player6 = new Players('Matt')
    let game3 = new Game(6);
    game3.playerOrder = [player1, player2, player3, player4, player5, player6];
    game3.assignParty();
  ...
  test('should remove a card from the master deck and add it to lib or fas policies', () => {
    ...
    game5.shuffleDeck();
    expect(game5.masterDeck.length).toEqual(16);
  ...
  test('should assign one player as president', () => {
    ...
    let player5 = new Players('George');
    let player6 = new Players('Matt')
    let game6 = new Game(6);
    game6.playerOrder = [player1, player2, player3, player4, player5, player6];
    ...
    expect(game6.playerOrder.length).toEqual(6)
  })
  test('should nominate one player as chancellor', () => {
    ...
    let player5 = new Players('George');
    let player6 = new Players('Matt')
    let game7 = new Game(6);
    game7.playerOrder = [player1, player2, player3, player4, player5, player6];
  ...
  test('should assign one player as dead', () => {
    ...
    let player5 = new Players('George');
    let player6 = new Players('Matt')
    let game8 = new Game(6);
    game8.playerOrder = [player1, player2, player3, player4, player5, player6];
    player1.shootPlayer(game8) ;
    expect(game8.playerOrder[0].length === 4);
    expect(player1.status).toEqual("Dead");
    expect(game8.players).toEqual(5)
  })
  test('should vote in a chancellor', () => {
    ...
    let player5 = new Players('George');
    let player6 = new Players('Matt')
    let game9 = new Game(6);
    game9.playerOrder = [player1, player2, player3, player4, player5, player6];
    game9.shuffleDeck();
    game9.totalYesVote = 4;
  ...
  test('should clean up the end of the round', () => {
    ...
    let player5 = new Players('George');
    let player6 = new Players('Matt')
    let game10 = new Game(6);
    game10.playerOrder = [player1, player2, player3, player4, player5, player6];
